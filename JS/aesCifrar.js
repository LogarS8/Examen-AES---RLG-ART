...
function cifrar24(filename, text){
    const mensaje = document.getElementById("Texto1").value;
...
function cifrar32(filename, text){
    const mensaje = document.getElementById("Texto4").value;
    const clave = document.getElementById("pass4").value;
    ...
    const cifrado = CryptoJS.AES.encrypt(mensaje, clave);
    document.getElementById("contenido1").innerHTML = cifrado;
